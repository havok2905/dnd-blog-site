    ...
    <>
      ...
      <Page>
        ...
        <Card>
          ...
          <p>
            - Robin Gallowglass; Commander of Celu Revolutionaries
          </p>
        </Card>
        <Card>
          <p>
          ...
          <p>
            - Journal of Henrick Montague; CEO and owner of the Montague Mining Company
          </p>
        </Card>
        <h3>The Battle of Habarashi</h3>
        <p>
        ...
        <Card>
          ...
          <p>
            - Interview with Eddard Stonecutter, First and last president of the New Habarashi Republic
          </p>
        </Card>
        <Card>
          <p>
          ...
          <p>
            - Journal of Maximilian Blisterwind, Maximilian Blisterwind; Governor of East Fey
          </p>
        </Card>
        ...
        <p>
          <strong>Arcane Batteries:</strong> These small crystals are embedded with power generated from any one of the Montague planar colonies. These devices have placed the power of the arcane in the hands of the average person, powering small appliances, lighting, heat, and travel.
        </p>
        <p>
          <strong>The Power Grid:</strong> The central power grid is made up of lanes of arcane power lines that stretch the continent. Arcane power generation primarily occurs within the plane of fire, by means of geothermal power generation. These power lines are heavily guarded and no attack has been successfully launched against them.
        </p>
        <p>
          <strong>The Ring Gates:</strong> While portals to the planes of existence have existed for centuries, the ability to allow mass transit between them is relatively new. These gates are always open and owned by the Montague Mining Company.
        </p>
        <h3>The Central Powers of Runoa</h3>
        <p>
          <strong>The Habarashi Empire:</strong> The Habarashi Empire spans the eastern half of Runoa, encompassing vast sand dunes, mediterranean coastal cities, haunted desolate wasteland, and vast western mountain ranges - all connected by the Habarashi Rail. Each region of the Habarashi Empire maintains its own culture, when allowed by the authoritarian military dictatorship.
        </p>
        <p>
          <strong>The Krossan Empire:</strong> The Krossan Empire spans the western half of Runoa, acting as the last remnants of the ancient elvish monarchy. These days, the territory of the crown spans frozen tundra, dense forest lands, tropical islands, and bustling naval ports. Though the monarchy currently remains in power, talk of its demise is ever looming. The Krossan empire has long been, since its establishment, loosly held together. A new and inexperienced queen's anointment has only emboldened those who would see the empire break.
        </p>
        <p>
          <strong>The Montague Mining Company:</strong> The Montague mining company began as a humble mining operation in the Scarlet Range mountains. However, with a shift in focus towards power generation, they would eventually force themselves into the foundation of every city on the map. The Montague mining company runs a number of extra-planar colonies across the planes of fire, earth, and ice. They also own and maintain portals into the planes, known as "Ring Gates".
        </p>
        <p>
          <strong>The Free Sails:</strong> The Free Sails are those who rebelled openly against the expansion of the Habarashi Empire and fled to the east in exile. These people settled in the eastern islands that make up Dragon's Spine, setting up independent towns outside of the purview of the empires. They are a distributed network of independent ships that loosely follow a code of conduct for mutual survival.
        </p>
        <p>
          <strong>Seinaru:</strong> Bustling ports, guildhalls, markets, and political debate flood the streets of Seinaru, also referred to as Sei to the local population. This island city state remains one of the lone neutral powers of the world, positioning itself between revolutionaries, empires, and pirates alike.
        </p>
        <p>
          <strong>The Emerald Sea:</strong> Having escaped much of the destruction imposed by Enkiem, the people of the Emerald Sea have thrived with little interruption. The people here are primarily agrarian and rural, living amongst a several hundred mile stretch of open grassland. The people of the Emerald Sea are relative new-comers to the political games of the west, more interested in observing from afar and lending out their talents to the highest bidder.
        </p>
      </Page>
    </>
  );
